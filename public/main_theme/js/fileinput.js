...
(function (factory) {
    ...
    $h = {
        ...
        closeButton: function (css) {
            ...
            return '<button style="display:none !important" type="button" class="' + css + '" aria-label="Close">\n' +
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tBtnDefault = '<button onclick="remove_image()" type="{type}" tabindex="500" title="{title}" class="{css}" ' +
            ...
            tActions = '<div class="file-actions">\n' +
                ...
                '<div class="clearfix"></div>';
            //noinspection HtmlUnknownAttribute
            tActionDelete = '<button style="display:none;" type="button" class="kv-file-remove delt {removeClass}" ' +
            ...
            tImage = '<img src="{data}" class="file-preview-image imge kv-preview-data" title="{caption}" ' +
                'alt="{caption}" {style}>\n';
