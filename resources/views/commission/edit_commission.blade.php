            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="page-title float-left">Edit Commission</h4>
...
$( "#submit22" ).click(function() {
	var low_unit_price = parseFloat($("#low_unit_price").val());
	var high_unit_price = parseFloat($("#high_unit_price").val());
	var unit_commission = $("#unit_commission").val();

	var hidden_high_unit_price = parseFloat($("#hidden_high_unit_price").val());
	var hidden_low_unit_price = parseFloat($("#hidden_low_unit_price").val());
	...
	if(low_unit_price > high_unit_price)
	{
	...
	var my_url = APP_URL+'/edit_ajax_low_unit_price';
	var formData = {
		low_unit_price:low_unit_price,
		high_unit_price:high_unit_price,
		hidden_high_unit_price:hidden_high_unit_price,
		hidden_low_unit_price:hidden_low_unit_price,
		}
	var type = "POST";
		$.ajaxSetup({
			headers: {
