    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-box">
                        {!! Form::open(['url' => 'customer/'.encrypt($customer->id),'class'=>'form-horizontal']) !!}	
						{{ Form::hidden('_method','PATCH') }}
                        <input type="hidden" name="customer_id" id="customer_id" value="{{$customer->id}}" />
                            <div class="form-group row">
                                <label class="col-2 col-form-label">Customer ID :</label>
                                <div class="col-4">
                                    <label class="col-form-label"><strong>{{$customer->customer_uniq_id}}</strong></label>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-4">
                                   {{ Form::text('customer_full_name',$customer->customer_full_name,['placeholder' => 'Full Name','autocomplete'=>'off','parsley-trigger' => 'change','required'=>'' , 'class' =>'form-control', 'id'=>'customer_full_name' ,'data-parsley-required-message'=>'Please Enter Full Name','data-parsley-maxlength'=>'100','maxlength'=>'100']) }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-4">
                                    {{ Form::text('address_1',$customer_address[0]->address_1,['placeholder' => 'Address 1','autocomplete'=>'off','parsley-trigger' => 'change','required'=>'' , 'class' =>'form-control', 'id'=>'address_1' ,'data-parsley-required-message'=>'Please Enter Address 1','data-parsley-maxlength'=>'100','maxlength'=>'100']) }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-4">
                                    {{ Form::text('address_2',$customer_address[0]->address_2,['placeholder' => 'Address 2','autocomplete'=>'off','parsley-trigger' => 'change', 'class' =>'form-control', 'id'=>'address_2' ,'data-parsley-maxlength'=>'100','maxlength'=>'100']) }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-4">
                                    {{ Form::text('address_3',$customer_address[0]->address_3,['placeholder' => 'Address 3','autocomplete'=>'off','parsley-trigger' => 'change', 'class' =>'form-control', 'id'=>'address_3' ,'data-parsley-maxlength'=>'100','maxlength'=>'100']) }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-4">
                                    {{ Form::text('city',$customer_address[0]->city,['placeholder' => 'City/Town','autocomplete'=>'off','parsley-trigger' => 'change','required'=>'' , 'class' =>'form-control', 'id'=>'city' ,'data-parsley-required-message'=>'Please Enter City/Town','data-parsley-maxlength'=>'50','maxlength'=>'50']) }}
                                	@if ($errors->has('city'))
                                        <ul class="parsley-errors-list filled">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-4">
                                    {{ Form::text('postal_code',$customer_address[0]->postal_code,['placeholder' => 'Post Code','autocomplete'=>'off','parsley-trigger' => 'change','required'=>'' , 'class' =>'form-control', 'id'=>'postal_code' ,'data-parsley-required-message'=>'Please Enter Post Code','data-parsley-maxlength'=>'100','maxlength'=>'100','data-parsley-minlength'=>'1']) }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-4">
                                    {{ Form::text('state',$customer_address[0]->state,['placeholder' => 'State','autocomplete'=>'off','parsley-trigger' => 'change','required'=>'' , 'class' =>'form-control', 'id'=>'state' ,'data-parsley-required-message'=>'Please Enter State','data-parsley-maxlength'=>'30','maxlength'=>'30']) }}
                                	@if ($errors->has('state'))
                                        <ul class="parsley-errors-list filled">
                                ...
                                <div class="col-4">
                                    <select class="selectpicker" name="country_id" id="country_id" data-live-search="true"  data-style="btn-light">
                                       @foreach($Countries as $country)
                                       		@if($country->id==$customer_address[0]->country_id)
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-4">
                                    {{ Form::email('email',$customer_address[0]->email,['placeholder' => 'Email','autocomplete'=>'off','parsley-trigger' => 'change', 'required'=>'' ,'data-parsley-required-message'=>'Please Enter Email', 'class' =>'form-control', 'id'=>'email' ,'data-parsley-maxlength'=>'100','maxlength'=>'100']) }}
                                 	@if ($errors->has('email'))
                                        <ul class="parsley-errors-list filled">
                        ...
                        <table id="multiple_add_table" class="table table-striped table-bordered table-hover table-sm" style="width: 100%;">
                            ...
                            <tbody>
                            @for($i=1;$i < $customer_address->count();$i++)
                            	
                                <tr id='row{{$i}}' >
                                <td>{{$customer_address[$i]->customer_full_name}}<input type='hidden' name='other_customer_full_name[]' value='{{$customer_address[$i]->customer_full_name}}' /></td>
                                
                                <td>{{$customer_address[$i]->address_1}}, {{$customer_address[$i]->address_2}}, {{$customer_address[$i]->address_3}}<input type='hidden' name='other_address_1[]' value='{{$customer_address[$i]->address_1}}' /><input type='hidden' name='other_address_2[]' value='{{$customer_address[$i]->address_2}}' /><input type='hidden' name='other_address_3[]' value='{{$customer_address[$i]->address_3}}' /></td>
                                
                                <td>{{$customer_address[$i]->city}}<input type='hidden' name='other_city[]' value='{{$customer_address[$i]->city}}' /></td>
                                
                                <td>{{$customer_address[$i]->postal_code}}<input type='hidden' name='other_postal_code[]' value='{{$customer_address[$i]->postal_code}}' /></td>
                                
                                <td>{{$customer_address[$i]->state}}<input type='hidden' name='other_state[]' value='{{$customer_address[$i]->state}}' /></td>
                                
                                <td>{{ $customer_address[$i]->country[0]->nicename }}<input type='hidden' name='other_country_id[]' value='{{$customer_address[$i]->country_id}}' /></td>
                                
                                <td>{{$customer_address[$i]->email}}<input type='hidden' name='other_email[]' value='{{$customer_address[$i]->email}}' /></td><td>{{$customer_address[$i]->mobile}}<input type='hidden' name='other_mobile[]' value='{{$customer_address[$i]->mobile}}' /><td ><a href='javascript:void();' title='Delete' onclick=delete_itemrow('row{{$i}}')><i class='mdi mdi-delete'></i></a></td></tr>
                            @endfor
                        ...
                        <form id="another_address">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                 ...
                                 <div class="form-group col-md-6">
                                   ...
                                   {{ Form::text('temp_postal_code','',['placeholder' => 'Post Code','autocomplete'=>'off','parsley-trigger' => 'change','required'=>'' , 'class' =>'form-control', 'id'=>'temp_postal_code' ,'data-parsley-required-message'=>'Please Enter Post Code','data-parsley-maxlength'=>'100','maxlength'=>'100','data-parsley-minlength'=>'1']) }}
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-12">
                                    ...
                                    </div><div id="temp_err_msg_mobile_no"></div>
                                </div>
                            </div>
                                </div>
                            </div>
...
function (value, requirement) {
	if($('#hidden_mobile').val()==value){return true;}
    var ret = '';
...
function (value, requirement) {
    ...
    var my_url = APP_URL+'/ajax_check_edit_customer_email_duplicate';
	var formData = {email:value,customer_id:customer_id}
