...
<link href="{{ asset('public/main_theme/css/fileinput.css') }}" rel="stylesheet" type="text/css" />
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="page-title float-left">New Product</h4>
                        <ol class="breadcrumb float-right">
                            <li class="breadcrumb-item"><a href="javascript:void();">Products</a></li>
                            <li class="breadcrumb-item"><a href="productDetail.php">Products Detail</a></li>
...
<script src="{{asset('public/main_theme/js/fileinput.min.js')}}"></script>
<script>
$("#input-pd").fileinput({
