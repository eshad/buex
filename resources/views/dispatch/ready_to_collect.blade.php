...
<div class="content-page">
    ...
    <div class="content">
        <div class="container-fluid">
        	{!! Form::open(['url' => 'submit_dispatch_collect_order/','class'=>'form-horizontal']) !!}	
            ...
            <div class="row">
               ...
               <div class="col-md-4">
                  ...
                  <input class="form-control" id="collect_by" type="text" name="collect_by"  parsley-trigger="change"  data-parsley-required-message="Please Enter Name" maxlength="100" >
                </div>
                </div>
              </div>
             ...
             <!-- container -->
                    ...
                    <div class="form-group text-right m-b-0">
                                <button  class="btn btn-primary waves-effect waves-light" type="submit" id="submit" >Handover</button>
